...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-7">
            <x-card>
                <h5 class="mb-4"><i class="fas fa-edit text-warning me-2"></i>Edit Contractor</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                <option value="general" {{ old('type', $contractor->type) == 'general' ? 'selected' : '' }}>General</option>
                                <option value="rfc" {{ old('type', $contractor->type) == 'rfc' ? 'selected' : '' }}>RFC Contractor</option>
                                <option value="jmr" {{ old('type', $contractor->type) == 'jmr' ? 'selected' : '' }}>JMR Contractor</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
