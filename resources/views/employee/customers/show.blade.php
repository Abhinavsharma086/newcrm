...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('employee.customers.edit', [$customer, 'section' => request('section', 'registration')]) }}" class="btn btn-primary">
                <i class="fas fa-edit"></i> Edit/Update Details
            </a>
    ...
    <div class="tab-content" id="customerTabsContent">
        ...
        <div class="tab-pane fade" id="technical" role="tabpanel" aria-labelledby="technical-tab">
            <div class="row">
                <!-- Left Column: Technical Specs and Contractors -->
                <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-borderless table-sm">
                                    ...
                                    <tr><th class="text-secondary">RFC Contractor:</th><td>{{ $customer->rfc_contractor ?? 'N/A' }}</td></tr>
                                    <tr><th class="text-secondary">RFC Date:</th><td>{{ $customer->rfc_date ? $customer->rfc_date->format('d M Y') : 'N/A' }}</td></tr>
                                </table>
                            </div>
                            <div class="col-md-6">
                                <table class="table table-borderless table-sm">
                                    <tr><th style="width: 45%;" class="text-secondary">JMR Contractor:</th><td>{{ $customer->jmr_contractor ?? 'N/A' }}</td></tr>
